  ...
  events: {
    'Welcome Party (12 Aug)': [
      ...
      { name: 'Lounge Booths', capacity: '4–6 people', booths: [
        ...
        { code: '300', price: '$1,220', sold: true },
        { code: '301', price: '$1,220', sold: true },
    ...
    'No Signal (13 Aug)': [
      ...
      { name: 'VIP Booths', capacity: '7 people', booths: [
        ...
        { code: 'VIP 2', label: '2', price: '$488', sold: true },
    ...
    'The Send-Off (17 Aug)': [
      ...
      { name: 'High Tables', capacity: '4 people', booths: [
        { code: 'HIGH Table 1', label: '1', price: '$305', sold: true },
        { code: 'HIGH Table 2', label: '2', price: '$305', sold: true },
        { code: 'HIGH Table 3', label: '3', price: '$305', sold: true },
        { code: 'HIGH Table 4', label: '4', price: '$305', sold: true }
      ]}
    ]
  }
};
